...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  ...
  /* Add a keyword so the function can be paid. 
      ...
      This function should transfer money to the seller, set the buyer as the person who called this transaction, and set the state
    to Sold. Be careful, this function should use 3 mo compiledifiers to check if the item is for sale,
